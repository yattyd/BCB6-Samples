...
protected:
	...
	virtual void __fastcall SetVisibleBalloon(bool Value);
...
public:
	...
	virtual void __fastcall Balloon();
...
__published:
	// Properties
__property bool VisibleBalloon = {read = VisibleBalloon, write = SetVisibleBalloon, default=true};
